...
public class Trail2b {
	...
	@Test
	public void validTrailTest2() throws InterruptedException {
	...
	trailPOM.sendEmailAddress("ushanaw34na@gmail.com");
	driver.findElement(By.xpath("//body/div/main/div/div/div/form[@name='signupForm']/div/span[1]")).click();
	System.out.println("Terms and poliy check box highligted");
